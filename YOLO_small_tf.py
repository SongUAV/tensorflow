...
class YOLO_TF:
	...
	def __init__(self,argvs = []):
		...
		if self.detect_from_webcam is not None: self.detect_from_webcam(cam_num=0)
	def argv_parser(self,argvs):
		for i in range(1,len(argvs),2):
			...
			if argvs[i]	== '-from_webcam' : self.from_webcam=True
	...
	def detect_from_webcam(self,cam_num):
